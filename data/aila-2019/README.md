...
- config_name: truths
  data_files:
  - split: test
    path: ["qrels.txt", "queries.jsonl", "dataset-metadata.json", "config.json"]
...
AILA 2019 legal retrieval: prior cases and statutes from the Supreme Court of India (FIRE 2019).
